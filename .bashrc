...
&& echo \"not installing metagraph bc we are using Jim's abstract props branch right now # && conda install ~/dump/metagraph-0.0.1-py3.7h39e3cac_g15c13c6_12.tar.bz2 \"
