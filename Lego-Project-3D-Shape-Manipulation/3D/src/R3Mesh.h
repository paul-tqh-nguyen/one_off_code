...
struct R3Mesh {
  ...
  void DeleteAllFaces();
  void CreateTriangleAt(double xa, double ya, double za, 
                        double xb, double yb, double zb, 
                        double xc, double yc, double zc);
  void CreateSquareAt(double xa, double ya, double za, 
                      double xb, double yb, double zb, 
                      double xc, double yc, double zc, 
                      double xd, double yd, double zd);
  void CreateBoxAt(double x, double y, double z, double width);
  void CreateDoubleBoxAt(double x0, double y0, double z0, double x1, double y1, double z1, double width);
  void Voxel(string file_name);
  void Singles(string file_name);
  void Doubles(string file_name);
  void Lego(string singles_file_name, string doubles_file_name);
