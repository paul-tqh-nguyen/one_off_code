...
class HyperParameterSearchObjective:
    ...
    def get_trial_hyperparameters() -> list:
        ...
        hyperparameters = [learning_rate, number_of_epochs, batch_size, gradient_clip_val, embedding_size, regularization_factor, dropout_probability]
        return hyperparameters

    def __call__(self, trial: optuna.Trial) -> float:
        gpu_id = self.gpu_id_queue.get() if self.gpu_id_queue else DEFAULT_GPU

        hyperparameters = self.get_trial_hyperparameters()
        ...
        try:
            with suppressed_output():
                with warnings_suppressed():
                    best_validation_loss = model_class.train_model(
    ...
    with _training_logging_suppressed():
        ...
        if not HYPERPARAMETER_SEARCH_IS_DISTRIBUTED:
            ...
            with mp.Manager() as manager:
                ...
                optimize_kawrgs['func'] = HyperParameterSearchObjective(self.model_class, gpu_id_queue)
