...
def link_predictor_hyperparameter_search(graph: nx.Graph, positive_edges: np.ndarray, negative_edges: np.ndarray) -> None:
    ...
    with mp.Manager() as manager:
        ...
        # more_itertools.consume((gpu_id_queue.put(gpu_id) for gpu_id in (GPU_IDS * HYPERPARAMETER_TRIALS_PER_GPU))) @ todo rmevoe this
        ...
        # optimize_kwargs['n_jobs'] = len(GPU_IDS) * HYPERPARAMETER_TRIALS_PER_GPU # @todo remove this
        optimize_kwargs['n_jobs'] = len(GPU_IDS)
