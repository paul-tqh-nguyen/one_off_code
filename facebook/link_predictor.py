...
class FBDataModule(pl.LightningDataModule):
    ...
    def setup(self) -> None:
        ...
        print(f"Data Module Training Portion: {TRAINING_PORTION}")
        print(f"Data Module Validation Portion: {VALIDATION_PORTION}")
        print(f"Data Module Testing Portion: {TESTING_PORTION}")
