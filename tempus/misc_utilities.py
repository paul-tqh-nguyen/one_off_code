...
import numpy as np
def visualize_vectors(matrix: np.ndarray, labels: np.ndarray, output_file_location: str) -> None:
    import matplotlib
    ...
    with temp_plt_figure(figsize=(20.0,10.0)) as figure:
        def add_plot(position: int, matrix_to_plot: np.ndarray, plot_title: str):
            ...
            plot.scatter(matrix_to_plot[:,0], matrix_to_plot[:,1], c=colors, alpha=0.5)
